...
return {
  -- add a few keybindings
  {
    ...
    opts = function(_, opts)
      ...
      -- file explorer
      maps.n["<c-n>"] = function() require("vscode").action "workbench.files.action.focusFilesExplorer" end
      ...
      -- LSP Mappings
      maps.n["gh"] = function() require("vscode").action "editor.action.showHover" end
      ...
      maps.n["<Leader>ca"] = function() require("vscode").action "editor.action.quickFix" end
