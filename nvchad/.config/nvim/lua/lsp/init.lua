...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(event)
    ...
    local diagnostics = {
      ...
      signs = {
        text = {
          [vim.diagnostic.severity.ERROR] = require("configs.ui").icons.dia.Error,
          [vim.diagnostic.severity.WARN] = require("configs.ui").icons.dia.Warn,
          [vim.diagnostic.severity.HINT] = require("configs.ui").icons.dia.Hint,
          [vim.diagnostic.severity.INFO] = require("configs.ui").icons.dia.Info,
        },
      },
    }
